		...
		if( Km_count > 0 ){
		  ...
		  if( Km_count > select_kaonM_1 ){
		    ...
		    */
		    ...
		    if( Q2 > 1 && W > 0 ) h_w_cut[6]->Fill(W);
		    if( Q2 > 1 ) h_q2_cut[6]->Fill(Q2);
		    if( Q2 > 1 && x > 0 ) h_x_cut[6]->Fill(x);
		    if( Q2 > 1 && y > 0 ) h_y_cut[6]->Fill(y);
		    if( Q2 > 1 && nu > 0 ) h_nu_cut[6]->Fill(nu);
		    if( Q2 > 1 && t1 > 0 ) h_t_cut[4]->Fill(t1);
		    if( Q2 > 1 && cmphi1 != 0 ) h_cmphi_cut[4]->Fill(cmphi1 * 180/Pival);
		    if( Q2 > 1 && cmcostheta1 != 0 ) h_cmcostheta_cut[4]->Fill(cmcostheta1);
		    if( Q2 > 1 && t1 > 0) h_q2_t_cut[5]->Fill(Q2,t1);

		    if( W > 2 ) h_w_cut[7]->Fill(W);
		    if( W > 2 && Q2 > 0 ) h_q2_cut[7]->Fill(Q2);
		    if( W > 2 && x > 0 ) h_x_cut[7]->Fill(x);
		    if( W > 2 && y > 0 ) h_y_cut[7]->Fill(y);
		    if( W > 2 && nu > 0 ) h_nu_cut[7]->Fill(nu);
		    if( W > 2 && t1 > 0 ) h_t_cut[5]->Fill(t1);
		    if( W > 2 && cmphi1 != 0 ) h_cmphi_cut[5]->Fill(cmphi1* 180/Pival);
		    if( W > 2 && cmcostheta1 != 0 ) h_cmcostheta_cut[5]->Fill(cmcostheta1);
		    if( Q2 > 0 && x > 0 )h_q2_x_cut[9]->Fill(x,Q2);
		    if( Q2 > 0 && W > 0 )h_q2_w_cut[6]->Fill(W,Q2);
		    if( W > 2 && t1 > 0) h_q2_t_cut[6]->Fill(Q2,t1);
	  
		    if( Q2 > 1 && x > 0 )h_q2_x_cut[10]->Fill(x,Q2);
		    if( Q2 > 1 && x > 0 && W > 2 )h_q2_x_cut[11]->Fill(x,Q2);
		    if( Q2 > 1 && W > 2 )h_q2_w_cut[7]->Fill(W,Q2);
		    if( Q2 > 1 && W > 2 && t1 > 0) h_q2_t_cut[7]->Fill(Q2,t1);

		    if( x > 0 && t1 > 0 ) h_x_t_cut[8]->Fill(x,t1);
		    if( x > 0 && t1 > 0 && Q2 > 1 ) h_x_t_cut[9]->Fill(x,t1);
		    if( x > 0 && t1 > 0 && W > 2 ) h_x_t_cut[10]->Fill(x,t1);
		    if( x > 0 && t1 > 0 && Q2 > 1 && W > 2 ) h_x_t_cut[11]->Fill(x,t1);

		    if( cmphi1 != 0 && t1 > 0 ) h_t_phi_cut[8]->Fill(cmphi1* 180/Pival,t1);
		    if( cmphi1 != 0 && t1 > 0 && Q2 > 1 ) h_t_phi_cut[9]->Fill(cmphi1* 180/Pival,t1);
		    if( cmphi1 != 0 && t1 > 0 && W > 2 ) h_t_phi_cut[10]->Fill(cmphi1* 180/Pival,t1);
		    if( cmphi1 != 0 && t1 > 0 && Q2 > 1 && W > 2 ) h_t_phi_cut[11]->Fill(cmphi1* 180/Pival,t1);

		    if( Q2 > 0 && cmphi1 != 0 ) h_q2_phi_cut[8]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && Q2 > 1 ) h_q2_phi_cut[9]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && Q2 > 0 && W > 2 ) h_q2_phi_cut[10]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && Q2 > 1 && W > 2 ) h_q2_phi_cut[11]->Fill(cmphi1* 180/Pival, Q2);

		    if( W > 0 && cmphi1 != 0 ) h_q2_phi_cut[8]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && W > 2 ) h_q2_phi_cut[9]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && W > 0 && Q2 > 1 ) h_q2_phi_cut[10]->Fill(cmphi1* 180/Pival, Q2);
		    if( cmphi1 != 0 && W > 2 && Q2 > 1 ) h_q2_phi_cut[11]->Fill(cmphi1* 180/Pival, Q2);
